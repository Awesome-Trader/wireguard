...
```bash
wget https://raw.githubusercontent.com/Automated-Systems/wireguard/master/wg-ubuntu-server-up.sh
...
```bash
wget https://raw.githubusercontent.com/Automated-Systems/wireguard/master/wg-debian-server-up.sh
